...
class AppRouter extends _i5.RootStackRouter {
  ...
  final Map<String, _i5.PageFactory> pagesMap = {
    ...
    StarredReposRoute.name: (routeData) {
      return _i5.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i2.StarredReposPage(),
      );
    },
    ...
    AthorizationRoute.name: (routeData) {
      final args = routeData.argsAs<AthorizationRouteArgs>();
      return _i5.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i4.AthorizationPage(
          key: args.key,
...
/// generated route for
/// [_i4.AthorizationPage]
class AthorizationRoute extends _i5.PageRouteInfo<AthorizationRouteArgs> {
  AthorizationRoute({
    _i6.Key? key,
  ...
  static const String name = 'AthorizationRoute';
}

class AthorizationRouteArgs {
  const AthorizationRouteArgs({
    this.key,
  ...
  @override
  String toString() {
    return 'AthorizationRouteArgs{key: $key, authorizationUrl: $authorizationUrl, onAuthorizationCodeRedirectAttempt: $onAuthorizationCodeRedirectAttempt}';
  }
}
